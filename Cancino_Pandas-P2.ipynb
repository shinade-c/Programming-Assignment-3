 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 13,
   "id": "553e40bf-5aec-4e16-9e63-cc4bf2db8cc4",
   "metadata": {},
   "outputs": [],
   "source": [
    "#Problem 2"
  ...
  },
  {
   ...
   "source": [
    "#Load the dataset into a DataFrame called cars\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "cars.iloc[0:5, ::2] # ::2 means select every other column starting from index 0"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "# c. Display how many cylinders does Camaro Z28 have\n",
  ...
  },
  {
   ...
   "source": [
    "# d. Display the cylinders and gear type for Mazda RX4 Wag, Ford Pantera L, and Honda Civic\n",
